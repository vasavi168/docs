...
```
{endpoint}mip/message/status?id=cdf829fd-5148-44bb-8433-xxxxx
```
...
```curl
curl -X GET \
  '{endpoint}mip/message/status?access_token=209eccd40e45b21xxxx&id=cdf829fd-5148-44bb-8433-xxxxx'
```
