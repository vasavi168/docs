...
#### The following are the list of sender_id prefixes and their explanation:
...
* MOBtexting reserves the right to reject your Sender-ID request if it finds it does not comply to these Dos and Don'ts. Having said that, we are here to make it easy for you send your SMS, so we will give you our reasons and suggest alternatives. 
